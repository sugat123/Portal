    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applied', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='match_aplied_user_id', to=settings.AUTH_USER_MODEL)),
                ('posted', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='match_posted_user_id', to=settings.AUTH_USER_MODEL)),
            ],
            options={
