# Generated by Django 2.2.3 on 2019-08-05 05:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.ManyToManyField(blank=True, null=True, to='jobs.Facility')),
                ('job_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobs.JobType')),
                ('skills', models.ManyToManyField(blank=True, null=True, to='jobs.Skills')),
